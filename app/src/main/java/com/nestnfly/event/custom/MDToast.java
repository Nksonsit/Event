        ...
        switch (type) {
            ...
            case TYPE_WARNING:
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                    ...
                    view.setBackgroundColor(ContextCompat.getColor(context, R.color.color_warning));
                break;
            case TYPE_ERROR:
                ...
                } else view.setBackgroundColor(ContextCompat.getColor(context, R.color.color_error));
                break;
            default:
                ...
                } else view.setBackgroundColor(ContextCompat.getColor(context, R.color.color_info));
                break;
        }
